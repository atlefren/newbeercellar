    ...
    render: function () {
        return (
            ...
            React.createElement("input", {
                ...
                onKeyUp: this.search}), 
                React.createElement("ul", {className: "dropdown-menu", style: "display: block;"}, 
                    React.createElement("li", null, React.createElement("a", {href: "/facilities/63", tabindex: "-1"}, "Bispehaugen skole gymsal")), 
                    React.createElement("li", null, React.createElement("a", {href: "/facilities/264", tabindex: "-1"}, "Brannhaugen barnehage hjerterommet"))
                )
            )
        );
    }
