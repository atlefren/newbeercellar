...
(function (ns) {
    ...
    ns.BottleElement = React.createClass({
        ...
        render: function () {          
            ...
            if (!this.state.showEdit) {
                ...
                elementNodes.unshift(
                    <ns.SaveBtn saveBottle={this.saveBottle} />
                );                
            }
            return (<tr onMouseEnter={this.mouseEnter} onMouseLeave={this.mouseLeave}>{elementNodes}</tr>);
